...
Often the variability in efficacy data varies across the dynamic range of an assay and is better represented by the CV, @sec-effVar. Unfortunately this violates a primary assumption in the analysis, making the replicate-experiment less useful. This is illustrated in the following example, where the CV is 10% across the assay range.
...
![Potency Correlation plot.](Webtool Output/MSR3data32_POT_2024-10-28 13_03_06.293975/MSR3data32_CorrFig_2024-10-28 13_02_38.773078.png){#fig-potCorr}
